...
Для начала скачать себе репозиторий: https://github.com/IgorZyktin/Zet/archive/master.zip

```
Как максимум: 1) Скачать репозиторий.
              2) Положить свои заметки в каталог source.
              3) Запустить run_linker_py.bat.

Это если в системе есть установленный питон, желательно версии 3.8 и выше.
```

```
Как минимум: 1) Скачать репозиторий.
             4) Положить свои заметки в каталог source.
             5) Запустить run_linker_exe.bat.
```
...
--source_directory "my cool folder"  | Выбрать каталог исходных данных
--target_directory "my cool folder"  | Выбрать каталог для сохранения
